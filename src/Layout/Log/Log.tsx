...
const Log = () => {
    ...
    return (
        <div className="pointsLogContainer">
            ...
            <Table columns={currViewLog === 'points' ? pointsColumn : currViewLog === 'approval' ? approvalColumns : gameColumns} dataSource={currViewLog === 'points' ? pointsLog : currViewLog === 'approval' ? approvalLog : gameLog} />
        </div>
    )
}
